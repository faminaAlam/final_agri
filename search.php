  ...
  <div class="row">
    ...
    <div class="jumbotron">
      ...
      <div>
        ...
        <img src="img/mix.jpg" class="img-responsive" >
      </div>
    </div>
    </div>
...
$res1=mysqli_query($db,"select DISTINCT(disease.disease_name),disease.disease_sol,disease.disease_image from disease,mayhave where disease.crops_name = '".$search."' ");
 while($row=mysqli_fetch_array($res))
 {
     ...
     echo"<div class=\"my\">
     <h1 id =\"K\">".$search."</h1>
     <h1 id=\"F\">Cultivation</h1>
     <p>".$c."</p><br>
     <h1 id=\"F\">Fertiliser</h1>
     <p>".$d."</p><br>
     <h1 id=\"F\">Careness</h1>
      <p>".$e."</p><br>
      <h1 id=\"F\">CropCollection</h1>
      <p>".$f."</p><br>
      <h1 id=\"F\">Collection</h1>
      <p>".$g."</p><br>
      <h1 id=\"F\">Writer</h1>
      <p>".$h."</p><br>
     </div>";
    echo "<h1 id=\"M\">Disease</h1>" ;
    while($k=mysqli_fetch_array($res1))
     {
         $m=$k['disease_name'];
         $n=$k['disease_sol'];
         $p=$k['disease_image'];
         echo"<div class=\"Famina\">
         <h1>".$m."</h1>
         <img src=".$p.">
         <p>".$n."</p>
         </div>";
