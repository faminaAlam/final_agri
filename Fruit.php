...
$res=mysqli_query($db,"SELECT * FROM crops NATURAL JOIN crops_image WHERE catagory_name='Fruit'");
      ...
      <div class=\"row\">
        ...
        <div class=\"col-sm-9\">
          ...
          <a href=\"detail_info.php?ach=$crop_name\">".$crop_name." garden</a>
            <p>To know more about this fruit CLICK  <a href=\"detail_info.php?ach=$crop_name\">".$crop_name." </a></p>
          </div>
        </div>
      </div>";
    }
